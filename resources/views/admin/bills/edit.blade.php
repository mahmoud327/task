        ...
        <div class="row box border m-0 p-5  ">
            ...
            <div class="col-md-6 input-group mb-3 w-50 ">
                ...
                <select class="js-example-basic-multiple w-50" name="type_bill" id="inputGroupSelect01">
                    <option value="1" {{ $bill->type_bill=1 ?'seleced' :''}}>مبلغ مقابل طرد</option>
                    <option value="2" {{ $bill->type_bill=2 ?'seleced' :''}}>طرد مقابل طرد</option>
                    <option value="3" {{ $bill->type_bill=3 ?'seleced' :''}}>طرد بدوو مقابل</option>
                </select>
            ...
            <div class="input-group mb-3  w-50 ">
                ...
                <input type="text" class="form-control"  value="{{ $bill->product_name }}"name="product_name"placeholder="اسم المنتج" min="0"
                    aria-label="Recipient's username" aria-describedby="basic-addon2">
            </div>
            <div class="input-group mb-3  w-50 ">
                <span class="input-group-text bg-primary text-white"  value="{{ $bill->number_of_pieces }}" id="basic-addon2">عدد القطع </span>
            ...
            <div class="input-group mb-3  w-50 ">
                ...
                <input type="date" class="form-control"   value="{{ $bill->date_bills }}"name="date_bills" placeholder="uto" aria-label="Recipient's username"
                    aria-describedby="basic-addon2">
            </div>
            <div class="input-group mb-3  w-25 ">
                <span class="input-group-text bg-primary text-white" id="basic-addon2">السعر </span>
                <input type="text" class="form-control"   value="{{ $bill->cost }}" name="cost" placeholder="السعر" aria-label="Recipient's username"
                    aria-describedby="basic-addon2">
            </div>
            <div class="input-group mb-3  w-25 ">
                ...
                <input type="text" class="form-control" name="weight" placeholder="الوزن"
                    aria-label="Recipient's username"   value="{{ $bill->weight }}" aria-describedby="basic-addon2">
            </div>
            <div class="input-group mb-3  w-50 ">
                <span class="input-group-text bg-primary text-white" id="basic-addon2">البيان </span>
                <input type="text" class="form-control"  value="{{ $bill->statement }}" name="statement" placeholder="البيان"
                    aria-label="Recipient's username" aria-describedby="basic-addon2">
            </div>
            ...
            <div class="input-group  mb-3">
                ...
                <textarea class="form-control" name="note" id="exampleFormControlTextarea1" rows="3">{{ $bill->note }}</textarea>
            </div>
        </div>
    </div>
    <div class="container ">
        ...
        <div class="row box border m-0 p-5  ">
            ...
            <div class="col-md-6 input-group mb-3 w-50 ">
                ...
                <input type="text" naem="consignee"class="rounded-2 w-75" value="{{ $bill->consignee }}"  name="consignee">
            ...
            <div class="col-md-6 input-group mb-3 w-50 ">
                ...
                <select name="area_id" class="js-example-basic-multiple" id=area style="width: 80%">
                    ...
                    @foreach ($areas as $area)
                        <option onlyslave="True" value="{{ $area->id }}" {{$area->id ==$bill->area_id? 'selected':''}}>
                            {{ $area->area_name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="col-md-6 input-group mb-3 w-50  ">
                ...
                <input type="text" name="address" value="{{ $bill->address }}" class="rounded-2 w-75">
            ...
            <div class="input-group mb-3  w-50 ">
                ...
                <input type="text" class="form-control" name="special_marque"placeholder="علامه مميزه"
                    aria-label="Recipient's username" value="{{ $bill->special_marque }}"  aria-describedby="basic-addon2">
            </div>
            <div class="input-group mb-3  w-50 ">
                <span class="input-group-text bg-primary text-white" id="basic-addon2" >رقم التليفون </span>
                <input type="text" class="form-control"   value="{{ $bill->phone }}" name="phone"placeholder="رقم التليفون "
                    aria-label="Recipient's username" aria-describedby="basic-addon2">
            </div>
            <div class="input-group mb-3  w-25 ">
                <span class="input-group-text bg-primary text-white" id="basic-addon2">رقم تليفون اخر </span>
                <input type="text" class="form-control"  value="{{ $bill->phone2 }}" name="phone2"placeholder="رقم تليفون اخر"
                    aria-label="Recipient's username" aria-describedby="basic-addon2">
            </div>
    ...
    <div class="container ">
        ...
        <div class="row box border m-0 p-5  ">
            ...
            <div class="col-md-6 input-group mb-3 w-50 ">
                ...
                <input type="text" value="{{ $bill->company_name }}"  name="company_name"class="rounded-2 w-75">
            ...
            <div class="col-md-6 input-group mb-3 w-50 ">
                ...
                <input type="text" namr="amount_inclusive_expenses"  value="{{ $bill->amount_inclusive_expenses }}"  id="expenses"class="rounded-2 w-75">
            ...
            <div class="col-md-6 input-group mb-3 w-50  ">
                <label class="input-group-text bg-primary text-white" for="inputGroupSelect01"> مبلغ غير شامل
                    المصاريف</label>
                <input type="text" name="excluding_sum"  value="{{ $bill->excluding_sum }}" id="excluding_sum"class="rounded-2 w-75">
            </div>
            <div class="input-group mb-3  w-50 ">
                <label class="input-group-text bg-primary text-white" for="inputGroupSelect01"> قيمة الشحن</label>
                <input type="text" name="shipping_value" value="{{ $bill->shipping_value }}" id="shipping_value"class="rounded-2 w-75">
            </div>
            <div class="input-group mb-3  w-50 ">
                <label class="input-group-text bg-primary text-white" for="inputGroupSelect01"> الصافى</label>
                <input type="text" name="total"  value="{{ $bill->total }}"  id="total"class="rounded-2 w-75">
            </div>
